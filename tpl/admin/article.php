...
<div id="content">
    <section>
        <div class="section-header">
            <ol class="breadcrumb">
                <li><a href="/admin/articles">материалы</a></li>
                            ...
                            <div class="card-body tab-content">
                                ...
                                <div class="card-actionbar">
                                    <div class="card-actionbar-row">
                                        ...
                                        <?php if (!$article_id): ?>
                                            <a class="btn btn-flat" href="/admin/articles">Назад</a>
...
<?php if ($article_id): ?>
    <script>
        var myDropzone = new Dropzone(document.getElementById("my-dropzone"), {
            url: "/processorModule/articles/fileupload",
            params: {
...
//            location.reload();
    ...
    <script>
        $('.removeimg').click(function () {
            ...
            $.ajax({
                url: "/processorModule/articles/removeimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('.setmainimg').click(function () {
            var name = $(this).attr('data-name');
            $.ajax({
                url: "/processorModule/articles/setmainimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('#title').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/articles/title",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#title2').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/articles/title2",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#published').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/articles/published",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#featured').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/articles/featured",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#alias').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/articles/alias",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#section').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/articles/section",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#date').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/articles/date",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb').click(function () {
            ...
            $.ajax({
                url: "/processorModule/articles/full",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
...
<?php else: ?>
    ...
    <script>
        $('#submit').click(function () {
            ...
            $.ajax({
                url: "/processorModule/articles/addnew",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'ERROR') {
                        ...
                        window.location.href = "/admin/article?article_id=" + res.msg;
                    }
                }
            });
        });
