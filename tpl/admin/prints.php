...
<div id="content">
    ...
    <section>
        ...
        <div class="section-body contain-lg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-primary">Вся печать</h1>
                </div><!--end .col -->
                <div class="col-lg-8">
                    <article class="margin-bottom">
                        ...
                        <a href="/admin/print" class="btn ink-reaction btn-raised btn-primary">Добавить печать</a>
                    </article>
                </div><!--end .col -->
            </div><!--end .row -->
            <!-- END INTRO -->
            ...
            <table class="table table-hover">
                ...
                <?php foreach($all as $a):?>
                    <tr>
                        ...
                        <td><?= $g_config['print'][$a->section] ?></td>
                        <td><?=$a->title?></td>
                        ...
                        <td class="text-right">
                            <a href="/admin/print?article_id=<?=$a->article_id?>" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" data-original-title="Редактировать"><i class="fa fa-pencil"></i></a>
...
<script>
    $('.main').change(function () {
        ...
        if(inp == false) val = 0;
        $.ajax({
            url: "/processorModule/prints/pub",
            type: "POST",
            datatype: 'json',
            data: {
                hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
...
<script>
    $('.featured').change(function () {
        ...
        if(inp == false) val = 0;
        $.ajax({
            url: "/processorModule/prints/fet",
            type: "POST",
            datatype: 'json',
            data: {
                hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
