...
<div id="content">
    ...
    <section>
        ...
        <div class="section-body contain-lg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-primary">Все услуги</h1>
                </div><!--end .col -->
                <div class="col-lg-8">
                    <article class="margin-bottom">
                        ...
                        <a href="/admin/serv" class="btn ink-reaction btn-raised btn-primary">Добавить услугу</a>
                    </article>
                </div><!--end .col -->
            </div><!--end .row -->
            <!-- END INTRO -->
            ...
            <table class="table table-hover">
                ...
                <?php foreach($all as $a):?>
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="/admin/serv?article_id=<?=$a->article_id?>" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" data-original-title="Редактировать"><i class="fa fa-pencil"></i></a>
