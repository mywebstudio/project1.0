...
<div id="content">
    <section>
        <div class="section-header">
            <ol class="breadcrumb">
                <li><a href="/admin/servs">Все услуги</a></li>
                <li class="">Создание новой услуги</li>
            </ol>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Добавление/редактирование услуги</header>
                        </div>
                            ...
                            <div class="card-body tab-content">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="section" name="roof" class="form-control">
                                                    <?php foreach ($g_config['serv'] as $k => $v):?>
                                ...
                                <div class="card-actionbar">
                                    <div class="card-actionbar-row">
                                        ...
                                        <?php if (!$article_id): ?>
                                            <a class="btn btn-flat" href="/admin/servs">Назад</a>
...
<?php if ($article_id): ?>
    <script>
        var myDropzone = new Dropzone(document.getElementById("my-dropzone"), {
            url: "/processorModule/servs/fileupload",
            params: {
...
//            location.reload();
    ...
    <script>
        $('.removeimg').click(function () {
            ...
            $.ajax({
                url: "/processorModule/servs/removeimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('.setmainimg').click(function () {
            var name = $(this).attr('data-name');
            $.ajax({
                url: "/processorModule/servs/setmainimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('#title').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/title",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#short').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/short",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#sort').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/sort",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#price').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/price",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#published').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/servs/published",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#featured').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/servs/featured",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#alias').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/alias",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#section').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/section",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#date').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/date",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb2').click(function () {
            ...
            $.ajax({
                url: "/processorModule/servs/custom",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb').click(function () {
            ...
            $.ajax({
                url: "/processorModule/servs/full",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('.delete').click(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/servs/is_removed",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'OK') {
                        ...
                        window.location.href = "/admin/servs";
                    }
                }
            });
        });
...
<?php else: ?>
    ...
    <script>
        $('#submit').click(function () {
            ...
            $.ajax({
                url: "/processorModule/servs/addnew",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'ERROR') {
                        ...
                        window.location.href = "/admin/serv?article_id=" + res.msg;
                    }
                }
            });
        });
