...
<div id="content">
    ...
    <section>
        ...
        <div class="section-body contain-lg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-primary">Все страницы</h1>
                </div><!--end .col -->
                <div class="col-lg-8">
                    <article class="margin-bottom">
                        ...
                        <a href="/admin/page" class="btn ink-reaction btn-raised btn-primary">Добавить страницу</a>
                    </article>
                </div><!--end .col -->
            </div><!--end .row -->
            <!-- END INTRO -->
    ...
    <section class="style-default-bright">
        ...
        <div class="section-body">
            <h2 class="text-primary">Все страницы</h2>
