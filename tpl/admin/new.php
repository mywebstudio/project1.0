...
<div id="content">
    <section>
        <div class="section-header">
            <ol class="breadcrumb">
                <li><a href="/admin/projects">Статьи</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Добавление/редактирование статьи</header>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group floating-label">
                                                    ...
                                                    <label for="short">Введение</label>
                                                </div>
                                            </div><!--end .col -->
                            ...
                            <div class="card-body tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                <div class="checkbox checkbox-styled">
                                                    <label>
                                                        <input type="checkbox" id="featured" value="1" <?= $article_id ? $article->featured ? 'checked' : '' : 'checked' ?>  >
                                ...
                                <div class="card-actionbar">
                                    <div class="card-actionbar-row">
                                        ...
                                        <?php if (!$article_id): ?>
                                            <a class="btn btn-flat" href="/admin/news">Назад</a>
...
<?php if ($article_id): ?>
    <script>
        var myDropzone = new Dropzone(document.getElementById("my-dropzone"), {
            url: "/processorModule/new/fileupload",
            params: {
...
//            location.reload();
    ...
    <script>
        $('.removeimg').click(function () {
            ...
            $.ajax({
                url: "/processorModule/new/removeimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('.setmainimg').click(function () {
            var name = $(this).attr('data-name');
            $.ajax({
                url: "/processorModule/new/setmainimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('#published').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/new/published",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#featured').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/new/featured",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#section').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/new/section",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
...
<?php else: ?>
    ...
    <script>
        $('#submit').click(function () {
            ...
            $.ajax({
                url: "/processorModule/new/addnew",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'ERROR') {
                        ...
                        window.location.href = "/admin/new?article_id=" + res.msg;
                    }
                }
            });
        });
