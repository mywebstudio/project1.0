<div class="offcanvas">
    ...
    <div id="offcanvas-search" class="offcanvas-pane width-8">
        <div class="offcanvas-head">
            <header class="text-primary">Контакты</header>
            ...
            <ul class="list ">
                ...
                <li class="tile">
                    <a class="tile-content ink-reaction" href="#offcanvas-chat" data-toggle="offcanvas" data-backdrop="false">
                        <div class="tile-icon">
                            <img src="/i/image/admin/user.png" alt="" />
                        </div>
                        <div class="tile-text">
                            Alex Nelson
                            <small>+7 978 750 73 40</small>
                        </div>
                    </a>
                </li>
                <li class="tile">
    ...
    <div id="offcanvas-chat" class="offcanvas-pane style-default-light width-12">
        ...
        <div class="offcanvas-body">
            <ul class="list-chats">
                <li>
                    <div class="chat">
                        <div class="chat-avatar"><img class="img-circle" src="/i/image/admin/user.png" alt="" /></div>
                        <div class="chat-body">
