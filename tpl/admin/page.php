    ...
    <section>
        <div class="section-header">
            <ol class="breadcrumb">
                ...
                <li class="">Создание новой страницы</li>
            </ol>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Добавление/редактирование страницы</header>
                        </div>
                            ...
                            <div class="card-body tab-content">
                                ...
                                <div class="card-actionbar">
                                    <div class="card-actionbar-row">
                                        ...
                                        <?php if (!$article_id): ?>
                                            <a class="btn btn-flat" href="/admin/pages">Назад</a>
...
<?php if ($article_id): ?>
    <script>
        var myDropzone = new Dropzone(document.getElementById("my-dropzone"), {
            url: "/processorModule/pages/fileupload",
            params: {
...
//            location.reload();
    ...
    <script>
        $('.removeimg').click(function () {
            ...
            $.ajax({
                url: "/processorModule/pages/removeimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('.setmainimg').click(function () {
            var name = $(this).attr('data-name');
            $.ajax({
                url: "/processorModule/pages/setmainimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('#title').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/pages/title",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#sort').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/pages/sort",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#published').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/pages/published",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#alias').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/pages/alias",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#date').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/pages/date",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb').click(function () {
            var t = CKEDITOR.instances['full'].getData();

            $.ajax({
                url: "/processorModule/pages/full",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('.delete').click(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/pages/is_removed",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
...
<?php else: ?>
    ...
    <script>
        $('#submit').click(function () {
            ...
            $.ajax({
                url: "/processorModule/pages/addnew",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'ERROR') {
                        ...
                        window.location.href = "/admin/page?article_id=" + res.msg;
                    }
                }
            });
        });
