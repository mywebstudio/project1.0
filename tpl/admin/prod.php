...
<div id="content">
    <section>
        <div class="section-header">
            <ol class="breadcrumb">
                <li><a href="/admin/prods">Вся продукция</a></li>
                <li class="">Создание нового продукта</li>
            </ol>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-head style-primary">
                            <header>Добавление/редактирование продукта</header>
                        </div>
                            ...
                            <div class="card-body tab-content">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="section" name="roof" class="form-control">
                                                    <?php foreach ($g_config['prod'] as $k => $v):?>
                                ...
                                <div class="card-actionbar">
                                    <div class="card-actionbar-row">
                                        ...
                                        <?php if (!$article_id): ?>
                                            <a class="btn btn-flat" href="/admin/prods">Назад</a>
...
<?php if ($article_id): ?>
    <script>
        var myDropzone = new Dropzone(document.getElementById("my-dropzone"), {
            url: "/processorModule/prods/fileupload",
            params: {
...
//            location.reload();
    ...
    <script>
        $('.removeimg').click(function () {
            ...
            $.ajax({
                url: "/processorModule/prods/removeimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('.setmainimg').click(function () {
            var name = $(this).attr('data-name');
            $.ajax({
                url: "/processorModule/prods/setmainimg",
                type: "POST",
                datatype: 'json',
                data: {
                    name: name,
    ...
    <script>
        $('#title').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/title",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#short').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/short",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#price').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/price",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#published').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/prods/published",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#featured').change(function () {
            ...
            if(inp == false) val = 0;
            $.ajax({
                url: "/processorModule/prods/featured",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#alias').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/alias",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#section').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/section",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        $('#date').change(function () {
            var inp = $(this).val();
            $.ajax({
                url: "/processorModule/prods/date",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb2').click(function () {
            ...
            $.ajax({
                url: "/processorModule/prods/custom",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
    ...
    <script>
        ...
        $('#bbb').click(function () {
            ...
            $.ajax({
                url: "/processorModule/prods/full",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
            ...
            $.ajax({
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'OK') {
                        ...
                        window.location.href = "/admin/prods";
                    }
                }
            });
        });
...
<?php else: ?>
    ...
    <script>
        $('#submit').click(function () {
            ...
            $.ajax({
                url: "/processorModule/prods/addnew",
                type: "POST",
                datatype: 'json',
                data: {
                    hash: '<?= $_COOKIE['auto_admin_auth_pwd_hash']?>',
                ...
                success: function (jsondata) {
                    ...
                    if (res.status == 'ERROR') {
                        ...
                        window.location.href = "/admin/prod?article_id=" + res.msg;
                    }
                }
            });
        });
