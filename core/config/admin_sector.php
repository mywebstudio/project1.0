<?php
    ...
    $g_config['admin_sector']['salt']              = "replace_me_on_admin"; // Соль для хранения паролей в базе. По сути любой набор символов
    ...
    $g_config['admin_sector']['def_pwd']           = 'admin'; // Пароль для входа в административный раздел
?>
