<?php
    ...
    $g_config['phpIni']  = array
                            (
                                ...
                                'display_errors'     => true,            // Выводить ли ошибки в браузер
                                'memory_limit'       => '160M',                 // Максимальное коливество памяти на выполнение скрипта
                                'max_execution_time' => '200',                  // Максимальное время выполнения скрипта
                                'max_input_time'     => '200',                  // Время в течении которого скрипту разрешено получать данные
    ...
    $g_config['extrapacker']['removeDubCss']           = false; // Убрать повторяющиеся css/less файлы. Работает только когда packCss = false
    $g_config['extrapacker']['removeDubJs']            = false; // Убрать повторяющиеся js       файлы. Работает только когда packJs = false
