<?php
     ...
     *
     * IncludeCom("dev/paginator", 
     *     array
     *     (
     *         "pageUrl"      => SiteRoot("dev/pagesbar_example&page=" . M_PAGINATOR_PAGE),
     *         "firstPageUrl" => SiteRoot("dev/pagesbar_example"),
     *         "total"        => 400,
     *         "perPage"      => 11,
     *         "curPage"      => Get("page", 1)
     *     )
    ...
    else
    {
        ...
        $borders = array('left' => intval($left), 'right' => intval($right));
        ...
        if (!empty($template) && $template != "dev/paginator")
        {
            IncludeCom($template, array
            (
                "arrowLeft"   => $arrowLeft, 
                "pagesLeft"   => $pagesLeft, 
