 ...
 *
 *		config.smiley_path = 'http://www.example.com/i/image/smileys/';
 *
 *		config.smiley_path = '/i/image/smileys/';
 *
 * @cfg {String} [smiley_path=CKEDITOR.basePath + 'plugins/smiley/i/image/']
