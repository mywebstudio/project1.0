 ...
 */
CKEDITOR.config.format_tags = 'p;h1;h2;h3;h4;h5;h6;address;div;div2;blockquote';


/**
 * The style definition to be used to apply the `'Formatted'` format.
 *
 *		config.format_pre = { element: 'blockquote', attributes: { 'class': 'blockquote' } };
 *
 * @cfg {Object} [format_pre={ element: 'blockquote' }]
 * @member CKEDITOR.config
 */
 ...
 * @member CKEDITOR.config
 */
CKEDITOR.config.format_div2 = { element: 'div', attributes: { 'class': 'quote' } };
