...
define("SMSC_LOGIN", "smashcash");            // логин клиента
define("SMSC_PASSWORD", "smashcash");    // пароль или MD5-хеш пароля в нижнем регистре
...
define("SMTP_FROM", "info@smashcash.ru");     // e-mail адрес отправителя
